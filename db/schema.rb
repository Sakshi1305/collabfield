...
ActiveRecord::Schema.define(version: 20_200_713_064_143) do
  ...
  create_table 'private_conversations', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[recipient_id sender_id], name: 'index_private_conversations_on_recipient_id_and_sender_id', unique: true
